...
public class getfunctions {
	...
	public Response getfunctions() throws JSONException {
        ...
        JSONObject obj1 = new JSONObject();
			 Connection conn = null;
 				try {
					...
					e.printStackTrace();
	                String msg="obs_getFunctions Connection Failed.";
		 ...
		 try {
    		  ...
    		  String SQL = " select * from [dbo].[obs_getfunctions] WITH (NOLOCK) order by [FunctionName] ";
		  ...
		  //   System.out.println("First SQL:" + SQL);
			...
			//        System.out.println("result set created" );
					...
					// TODO Auto-generated catch block
					e.printStackTrace();
	                String msg="obs_getFunctions DB Query Failed.";
	                sb.append("{\"result\":\"FAILED\",\"resultCode\":200,\"message\":\""+msg+"\"");
	   	            rb=Response.ok(obj1.toString()).build();
	   	            return rb;
				   }
